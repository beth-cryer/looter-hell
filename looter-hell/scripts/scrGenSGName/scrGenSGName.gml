...
if (body == sprSGBody1) {
    switch(barrel) {
    case(sprSGBarrel1): return "Firehose"; break;
...
if (body == sprSGBody2) {
    switch(barrel) {
    case(sprSGBarrel1): return "Hulk"; break;
...
if (body == sprSGBody3) {
    switch(barrel) {
    case(sprSGBarrel1): return "Technician"; break;
...
if (body == sprSGBody4) {
    switch(barrel) {
    case(sprSGBarrel1): return "Bushwack"; break;
