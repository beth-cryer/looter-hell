//BODY1
if (body == sprSniperBody1) {
    switch(barrel) {
    case(sprSniperBarrel1): return "Assassin"; break;
...
//BODY3
if (body == sprSniperBody3) {
    switch(barrel) {
    case(sprSniperBarrel1): return "Athena"; break;
...
//BODY4
if (body == sprSniperBody4) {
    switch(barrel) {
    case(sprSniperBarrel1): return "Bratchny"; break;
