...
if (body == sprSMGBody1) {
    switch(barrel) {
    case(sprSMGBarrel1): return "Meteor"; break;
...
if (body == sprSMGBody2) {
    switch(barrel) {
    case(sprSMGBarrel1): return "Convergence"; break;
...
if (body == sprSMGBody3) {
    switch(barrel) {
    case(sprSMGBarrel1): return "SMG"; break;
...
if (body == sprSMGBody4) {
    switch(barrel) {
    case(sprSMGBarrel1): return "Constraint"; break;
